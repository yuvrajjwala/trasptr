  ...
  head: () => ({
    meta: [
      { title: "Your Profile — Eagle Black Limo" },
      {
        name: "description",
        content:
          "Manage saved addresses, payment preferences and notification settings for your Eagle Black Limo account.",
      },
      { property: "og:title", content: "Your Profile — Eagle Black Limo" },
      {
